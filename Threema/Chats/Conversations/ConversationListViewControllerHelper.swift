...
enum ConversationListViewControllerHelper {
    ...
    static func createPrivateAction(
        ...
        let privateAction = UIContextualAction(style: .normal, title: nil) { _, _, handler in
            ...
            guard KKPasscodeLock.shared().isPasscodeRequired() else {
                ConversationListViewControllerHelper.presentNoPasscodeAlert(viewController: viewController)
                handler(true)
                return
            }
            ...
            if isPrivate {
                ...
                ConversationListViewControllerHelper.showPrivateChatInfoAlert(
                    viewController: viewController,
