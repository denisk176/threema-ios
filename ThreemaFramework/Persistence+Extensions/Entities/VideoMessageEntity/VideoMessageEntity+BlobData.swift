...
extension VideoMessageEntity: BlobData {
    ...
    public var blobThumbnail: Data? {
        ...
        set {
            ...
            let thumbnailData: ImageDataEntity
            ...
            if let temporaryImage = UIImage(data: newValue) {
                thumbnailData.width = Int16(temporaryImage.size.width)
                thumbnailData.height = Int16(temporaryImage.size.height)
            }
