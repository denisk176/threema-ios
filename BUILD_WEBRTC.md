...
1. Change to the folder containing your iOS-project

    ```sh
    cd /path/to/your/ios-project-parent
    ```

2. Clone [libwebrtc Build Script](https://github.com/threema-ch/webrtc-build-docker) repository

    ```sh
    git clone https://github.com/threema-ch/webrtc-build-docker
    ```
...
4. Run build command with desired WebRTC commit (see _Versions_)
   
    ``` sh
    ./build-ios.sh <WebRTC Commit SHA> # See table below
    ```

5. Remove existing framework and move to correct location

    ```sh
    rm -r ../<iOS Project Folder Name>/WebRTC.xcframework
    mv artifacts/ios/WebRTC.xcframework ../<iOS Project Folder Name>/
    ```
...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------	| ---------------------------------------------------------------------------------------------------------------------------------------------	| ------------------------ 	| ----------------	| --------------------- |
| 7.3				| [e8b4d4c5952a8fb7b35c2a6cba4e8c3de2ea2e1e](https://chromium.googlesource.com/external/webrtc/+/e8b4d4c5952a8fb7b35c2a6cba4e8c3de2ea2e1e) (m149)	| [9f651bb81f35f2513f68089920010054d5b5970c](https://github.com/threema-ch/webrtc-build-docker/commit/9f651bb81f35f2513f68089920010054d5b5970c)	| 26.5.1 (25F80)			| 26.5 (17F42)		| 149.0					|
