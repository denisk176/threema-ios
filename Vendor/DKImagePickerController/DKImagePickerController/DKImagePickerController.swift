...
public protocol DKImagePickerControllerUIDelegate {
     ...
     */
    func imagePickerController(_ imagePickerController: DKImagePickerController, willSelectAssets: [DKAsset]) -> Bool
    ...
    /**
     Set the color/font of the navigation title.
     */
    func imagePickerControllerGlobalTitleColor() -> UIColor?
    
    func imagePickerControllerGlobalTitleFont() -> UIFont?
    
    /**
     Set the color of the AssetGroupList
     */
    func imagePickerControllerAssetGroupListBackgroundColor() -> UIColor?
    
    func imagePickerControllerAssetGroupListCellBackgroundColor() -> UIColor?
    
    func imagePickerControllerAssetGroupListCellTitleColor() -> UIColor?
    
    func imagePickerControllerAssetGroupListCellSubTitleColor() -> UIColor?
    
    func imagePickerControllerAssetGroupListCellTickImage() -> UIImage?
    
    /***** BEGIN THREEMA MODIFICATION: add gesture recognizer *********/
    /**
     Handle longpress for preview
     */
    func imagePickerControllerLongPress(_ imagePickerController: DKImagePickerController, _ selectedRow: Int, _ assets: [DKAsset])
...
open class DKImagePickerController : UINavigationController {
    ...
    /***** BEGIN THREEMA MODIFICATION: added all groups *********/
    ...
    public var assetGroupTypes: [PHAssetCollectionSubtype] = [
        ...
        .albumSyncedEvent,
        .smartAlbumAllHidden
        //.smartAlbumDepthEffect, ios 10.3
        //.smartAlbumLivePhotos, ios 10.3
        //.smartAlbumAnimated, ios 11
        //.smartAlbumLongExposures, ios 11
        ] {
        willSet(newTypes) {
            getImageManager().groupDataManager.assetGroupTypes = newTypes
        }
    }
    /***** END THREEMA MODIFICATION: added all groups *********/
    ...
    @objc public var didSelectAsset: ((_ pickerController: DKImagePickerController, _ asset: DKAsset) -> Void)?
    /***** END THREEMA MODIFICATION: function to check video size *********/
    ...
    /***** BEGIN THREEMA MODIFICATION: Call didSelectAssetse without dismissing the presentingViewController *********/
    @objc open func doneWithoutDismiss() {
        self.didSelectAssets?(self.selectedAssets)
//        self.dismiss(animated: false)
    }
    /***** END THREEMA MODIFICATION: Call didSelectAssetse without dismissing the presentingViewController *********/
    ...
    internal func selectImage(_ asset: DKAsset) {
        if self.singleSelect {
            ...
            if self.sourceType == .camera {
                ...
                /***** BEGIN THREEMA MODIFICATION: function to check video size *********/
                self.didSelectAsset?(self, self.selectedAssets.last!)
                /***** END THREEMA MODIFICATION: function to check video size *********/
